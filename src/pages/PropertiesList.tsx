...
const PropertiesList = () => {
    ...
    () => [
      {
        ...
        render: (p) => {
          const NoImagePlaceholder = (
            <div className="w-16 h-12 rounded-xl border border-gray-800 bg-bg-secondary flex flex-col items-center justify-center gap-1 text-[8px] text-gray-600 font-bold uppercase tracking-tighter">
          ...
          return (
            <div className="w-16 h-12 rounded-xl overflow-hidden border border-gray-700 bg-gray-900 shadow-inner shrink-0 relative group">
                ...
                <img
                  ...
                  onError={(e) => {
                    ...
                    target.insertAdjacentHTML(
                      "afterend",
                      `<div class="flex flex-col items-center justify-center gap-1 text-[8px] text-gray-500 font-bold uppercase w-full h-full bg-bg-secondary"><span>Error</span></div>`,
                    );
                  }}
                />
              ) : (
      ...
      },
      {
        ...
        accessor: "title",
        render: (p) => (
          <span className="text-text-main text-sm font-semibold whitespace-nowrap">
            {p.title}
          </span>
        ),
      },
      ...
      },
      {
        ...
        accessor: "price",
        render: (p) => (
          <span className="text-text-main font-black text-sm whitespace-nowrap">
  ...
  if (loading)
    return (
      <div className="p-20 text-text-main text-center">
        <Loader />
      </div>
    );

  return (
    <div className="p-4 md:p-6 lg:p-10 bg-bg-main min-h-screen">
      <DeleteModal
        isOpen={!!deleteId}
      ...
      <div className="w-full lg:w-[95%] xl:w-[90%] mx-auto mb-12 bg-bg-secondary border border-gray-15 rounded-2xl shadow-xl overflow-visible">
