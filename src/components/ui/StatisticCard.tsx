...
const StatisticCard = ({ card }: { card: StatisticCardType }) => {
  ...
  return (
    <div className="flex-1 flex flex-col gap-0.5 items-center lg:items-start border border-gray-15 rounded-lg 2xl:rounded-xl p-4 lg:px-5 lg:py-3.5 2xl:px-6 2xl:py-4">
