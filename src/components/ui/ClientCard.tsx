...
const ClientCard = ({ year, title, textButton, img1, titleBox1, PBox1,img2, titleBox2, PBox2, titleBoxBig, PBoxBig }: Clientcarddata) => {
  return <div className="flex flex-col gap-[30px] border-[4px] border-gray-15 md:p-[25px] sm:p-[20px] p-[15px] md:w-[500px] rounded-xl sm:w-[400px] w-[357px]">
    <div className="flex justify-between gap-[20px]">
      <div className="flex flex-col justify-center">
        <p className="text-gray-60 text-[16px]">{year}</p>
        <h3>{title}</h3>
      </div>
      <button className="border-[2px] border-gray-15 bg-gray-10 p-[20px] rounded-xl items-center">{textButton}</button>
    </div>
