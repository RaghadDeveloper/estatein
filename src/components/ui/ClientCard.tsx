...
const ClientCard = ({ year, title,  PBox1, PBox2, PBoxBig }: Clientcarddata) => {
  return <div className="flex flex-col border-1 border-gray-15   2xl:w-[775px] 2xl:h-[480px] 2xl:gap-[40px] 2xl:p-[50px] lg:w-[620px] lg:h-[420px] lg:gap-[30px] lg:p-[40px] w-[355px] h-[460px] gap-[24px] p-[30px] rounded-xl shadow-[0px_0px_0px_4px_#191919] lg:shadow-[0px_0px_0px_6px_#191919] 2xl:shadow-[0px_0px_0px_8px_#191919]">
