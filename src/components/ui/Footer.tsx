        ...
        <div className="flex flex-col gap-[20px]">
          ...
          <div className="flex gap-[10px] border-1 border-gray-15 w-fit p-5 rounded-xl">
            ...
            <input
              ...
              className="border-0 xl:w-[300px] md:w-[200px] w-[300px]"
            />
        ...
        <div className=" bg-gray-10 flex sm:justify-around sm:flex-row flex-col-reverse items-center gap-[10px] py-[20px] px-[5px]">
          ...
          <div className=" flex gap-[10px]">
            <div className="w-fit p-3 flex justify-center bg-gray-08 rounded-[25px]">
              <img src="/public/assets/icons/facebook.svg" alt="imgFooter1" />
            </div>
            <div className="w-fit p-3 flex justify-center bg-gray-08 rounded-[25px]">
              <img src="/public/assets/icons/linkedin.svg" alt="imgFooter1" />
            </div>
            <div className="w-fit p-3 flex justify-center bg-gray-08 rounded-[25px]">
              <img src="/public/assets/icons/twitter.svg" alt="imgFooter1" />
            </div>
            <div className="w-fit p-3 flex justify-center bg-gray-08 rounded-[25px]">
              <img src="/public/assets/icons/youtube.svg" alt="imgFooter1" />
            </div>
          </div>
        </div>
      </div>
