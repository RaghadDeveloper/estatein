...
const InfoCard = ({ icon, text, link }: InfoCardProps) => {
  return (
    <article className="py-5 px-3.5 lg:py-7.5 lg:px-4 xl:py-10 xl:px-5 bg-gray-10 border border-gray-15 rounded-[10px] flex flex-col relative items-center justify-center h-full">
      {/* Link Arrow */}
      <Link to={`${link}`}>
        <img
      ...
      {/* Card Icon */}
      <div className="flex items-center justify-center relative w-12 h-12 lg:w-15 lg:h-15 xl:w-20.5 xl:h-20.5">
        {/* borders */}
        ...
        {/* icon */}
        <img
          className="w-4 lg:w-[19.2px] xl:w-[30.6px] relative"
          src={icon}
          alt=""
        />
      </div>
      ...
      {/* Card Text */}
      <h3 className="text-[14px] lg:text-[16px] xl:text-[20px] mt-3.5 lg:mt-4 xl:mt-5 font-semibold flex-1 text-center cursor-default">
        {text}
      </h3>
    </article>
  );
