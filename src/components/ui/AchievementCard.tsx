...
const AchievementCard = ({ title, text }: AchievementsCardProps) => {
  return (
    <article className="flex flex-col h-full shadow-[0px_0px_0px_4px_var(--color-shadow)] lg:shadow-[0px_0px_0px_6px_var(--color-shadow)] 2xl:shadow-[0px_0px_0px_8px_var(--color-shadow)] p-7.5 lg:p-10 2xl:p-12.5 rounded-[10px] 2xl:rounded-xl">
