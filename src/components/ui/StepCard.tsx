...
const StepCard: React.FC<StepCardProps> = ({
  ...
  return (
    <div className="flex flex-col w-full lg:max-w-[413px] 2xl:max-w-[512px] font-urbanist mx-auto lg:mx-0">
      ...
      <div className="relative  lg:h-[222px] [@media(min-width:1441px)]:!h-[267px] p-8 md:p-10 bg-gray-08 border border-gray-15 rounded-xl rounded-tl-none overflow-hidden shadow-2xl">
        <div
        ...
        <div className="relative z-10 flex justify-center flex-col h-full">
          <h3 className="text-white text-[18px] min-[1440px]:text-[20px] min-[1920px]:text-[26px] font-semibold mb-5 leading-tight">
            {title}
          </h3>
