...
const StepCard = ({ stepNumber, title, description }: StepCardProps) => {
  return (
    <div className="flex flex-col w-full lg:max-w-103.25 2xl:max-w-lg font-urbanist mx-auto lg:mx-0">
      ...
      <div className="relative lg:h-55.5 [@media(min-width:1441px)]:h-66.75! p-px rounded-xl rounded-tl-none overflow-hidden bg-[linear-gradient(135deg,var(--color-primary-60),rgba(112,59,247,0.2)_20%,rgba(38,38,38,1)_100%)]">
