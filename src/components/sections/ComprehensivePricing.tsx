  ...
  return (
    <SectionContainer>
      ...
      <div className="flex flex-col gap-7.5 lg:gap-10 2xl:gap-12.5">
        {/* note */}
        <div className="rounded-lg 2xl:rounded-xl py-6 px-5 lg:py-5 lg:px-10 2xl:py-7.5 2xl:px-12.5 flex flex-col lg:flex-row lg:items-center gap-2.5 lg:gap-4 2xl:gap-5 bg-bg-secondary border border-gray-15">
          ...
          <p className="font-medium text-[14px] 2xl:text-[18px] text-text-secondary">
            {pricingDetailsNote}
          </p>
        </div>
        {/* details */}
        <div className="flex flex-col lg:flex-row gap-5 lg:gap-10 2xl:gap-12.5">
          ...
          <div className="flex flex-col gap-0.5">
            <p className="font-medium text-[14px] lg:text-[16px] 2xl:text-[20px] text-text-secondary">
              Listing Price
            </p>
