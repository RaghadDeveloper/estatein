import type { CommonHeroProps, FeatureItem, SectionHeaderProps, ServiceItem } from "../interfaces";
...
export const managementFeatureData: FeatureItem = {
  ...
  description: "Ready to experience hassle-free property management? Explore our Property Management Service categories and let us help you handle the complexities while you enjoy the benefits of property ownership.",
  bgImage: "/assets/images/abstractDesign/featureServiceCard.png",
};
