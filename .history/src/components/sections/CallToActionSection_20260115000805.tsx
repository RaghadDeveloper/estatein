...
const CallToActionSection = () => {
  return (
    ...
    px-4 py-12.5">
      ...
      <Link to="/properties" className="flex justify-center items font-medium text-[14px] 2xl:text-[18px]
      text-white bg-primary-60 rounded-[10px] w-full lg:w-fit">Explore Properties</Link>
    </section>
  )
}
