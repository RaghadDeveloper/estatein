...
const CallToActionSection = () => {
  return (
    ...
    px-4 py-12.5">
      <div>
        <h2 className="font-urbanist font-semibold leading-normal
        text-[28px] lg:text-[38px] 2xl:text-[48px] text-white mb-1.5 lg:mb-2.5
        2xl:mb-3.5">Start Your Real Estate Journey Today</h2>
        <p className="font-urbanist font-medium leading-normal
        text-[14px] text-gray-60">Your dream property is just a click away. Whether you're looking for a new home, a strategic 
      ...
      <Link to="/properties" className="font-urbanist font-medium text-[14px]
      text-white bg-color-pri">Explore Properties</Link>
    </section>
  )
}
