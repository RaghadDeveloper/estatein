...
const Slider = ({
  ...
  return (
    <div className="relative">
      ...
      <div className="flex items-center w-fit mx-auto p-2.5 rounded-[100px] bg-gray-08 gap-2.5">
        <SliderButton
            className="slider-prev"
            disabled={isPrevDisabled}
            image={{
            ...
            {cards.map((_, index) => {
              ...
              return (
                <button
                  ...
                  className={`${isActive?"bg-purple-600":"bg-gray-30"}
                  w-[11.17px] h-0.75 rounded-[60px] transition-colors cursor-pointer`}
