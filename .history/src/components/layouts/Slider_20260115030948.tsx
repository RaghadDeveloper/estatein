  ...
  return (
    <div className="relative">
      ...
      {/* buttons */}
        <div>
          <div>
            <span className="font-medium text-[14px] lg:text
            text-gray-60">{String(currentPage).padStart(2, "0")}</span>
            <span className="font-medium text-[14px] text-gray-60"> of </span>
            <span className="font-medium text-[14px] text-white">{String(totalPages).padStart(2, "0")}</span>
          </div>
