...
const PropertyPhotos = ({activeIndex,setActiveIndex}:PropertyPhotosProps) => {
  return (
    <div className="flex justify-between gap-2.5 lg:gap-5 p-2.5 lg:p-5 border border-gray-15 rounded-xl
    mb-5 2xl:mb-7.5">
      {photos.map((photo, index) => {
        ...
        return (
          <button
            ...
            className="relative w-36 aspect-4/3 border-0 rounded-md overflow-hidden cu"
          >
            <img
