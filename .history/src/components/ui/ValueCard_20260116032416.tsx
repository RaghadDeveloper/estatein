...
const ValueCard = ({className,isLast,image,title,description}:ValueCardProps) => {
  ...
  ${isLast?"pb-0 mb-0 border-b-0":"pb-5 lg:pb-0 mb-5 lg:mb-0 border-b lg:border-b-0 border-gray-15"}`}>
    ...
    <p className="font-medium leading-normal text-gray-60 text-[14px]
