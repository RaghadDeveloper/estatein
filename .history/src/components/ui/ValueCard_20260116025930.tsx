...
const ValueCard = ({className,image,title,description}:ValueCardProps) => {
  return <div className={`${className=="odd"?"lg:pl-6 lg:border-l lg:border-gray-15":"lg:pr-6"}
  pb-5 lg:pb-0 mb-5 lg:mb-0 border-b lg:border-b border-gray-15`}>
