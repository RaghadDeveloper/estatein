...
const PropertyPhotos = ({activeIndex,setActiveIndex}:PropertyPhotosProps) => {
  return (
    ...
    mb-5 2xl:mb-7.5
    overflow-x-auto lg:overflow-visible flex-nowrap lg:flex-wrap
      ...
      {photos.map((photo, index) => {
        ...
        return (
          <button
            ...
            className="relative shrink-0 lg:s w-16.75 lg:w-36 aspect-4/3 border-0 rounded-md overflow-hidden cursor-pointer"
          >
            <img
